...
from backend.routes import trucks, drivers, pti, loads, factoring, maintenance, documents, rc_parser, dat, auth, partners, vendors, trailers, fuel, accounting, payroll, reports, tolls
...
app.include_router(fuel.router,        dependencies=auth_dep)
app.include_router(accounting.router,  dependencies=auth_dep)
app.include_router(payroll.router,     dependencies=auth_dep)
