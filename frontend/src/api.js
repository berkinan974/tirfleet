...
export const getIftaSummary = (params) => api.get('/loads/ifta', { params }).then(r => r.data)
export const getIftaFuelByState = (params) => api.get('/loads/ifta/fuel-by-state', { params }).then(r => r.data)
